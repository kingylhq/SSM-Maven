 ...
 * Date:2016年6月5日下午1:39:13
 * Copyright @ 2010-2016 上海企垠信息科技有限公司  All Rights Reserved.
 *
*/
...
public class SortListUtil {
	...
	public static List<?> sort(List<?> list, final String field) {
		return sort(list, field, SortListUtil.ASC);
	}
	 ...
	 * @return
	 */
	public static <T> List<T> sortByMethod(List<T> list, final String method) {
	...
	@SuppressWarnings({ "unchecked", "rawtypes" })
	public static <T> List<T> sortByMethod(List<T> list, final String methods[],
			final String sorts[]) {
